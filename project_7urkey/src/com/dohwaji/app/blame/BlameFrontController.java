...
public class BlameFrontController extends HttpServlet{
	/**
	...
	protected void doProcess(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(command.equals("/blame/BlameEnrollment.bl")) {
			forward = new ActionForward();
			forward.setRedirect(false);
			forward.setPath("/app/member/blameForm.jsp");
			
		}else if(command.equals("/blame/BlameEnrollment.bl")){
			action = new BlameEnrollmentAction();
